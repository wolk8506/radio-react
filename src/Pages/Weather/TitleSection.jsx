  ...
  return (
    <>
      <div className="title-section">
        <div className="title-start-section">
          <div className="title-label">Ежечасно</div>
          <div className="parameter-buttons">
            <div className="forecast-type-buttons">
              <div className="forecast-type-group">
                {buttonData.map((el, index) => (
                  <button
                    key={index}
                    className={selectParams === el.value ? 'forecast-button forecast-button--active' : 'forecast-button'}
        ...
        {/* <div className="forecastButtonGroup-DS-EntryPoint1-2 outer">
          <button
            className="forecastButton-DS-EntryPoint1-2 forecastButtonActive-DS-EntryPoint1-2"
            title="Диаграмма"
          ...
          >
            ...
            <span className="forecastButtonLabel-DS-EntryPoint1-1">Диаграмма</span>
          </button>
          <button
            className="forecastButton-DS-EntryPoint1-2"
            title="Список"
            aria-label="Список"
          ...
          >
            ...
            <span className="forecastButtonLabel-DS-EntryPoint1-1">Список</span>
          </button>
        </div> */}
      </div>
